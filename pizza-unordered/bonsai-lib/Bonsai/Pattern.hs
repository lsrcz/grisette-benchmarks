...
type HandlerType0 m e t = ExceptT e UUnionM t

type HandlerType1 m e t = UUnionM (BonsaiTree m) -> HandlerType0 m e t

type HandlerType2 m e t = UUnionM (BonsaiTree m) -> HandlerType1 m e t

type HandlerType3 m e t = UUnionM (BonsaiTree m) -> HandlerType2 m e t

type HandlerType4 m e t = UUnionM (BonsaiTree m) -> HandlerType3 m e t

type HandlerType5 m e t = UUnionM (BonsaiTree m) -> HandlerType4 m e t
...
applyHandler :: [UUnionM (BonsaiTree m)] -> PatternHandler m e t -> ExceptT e UUnionM t
