...
symt =
  Table
    "t"
    ["tid", "name"]
    (mrgReturn [(mrgReturn . Just <$> [ssymb "t0-0", ssymb "t0-1"], ssymb "t0-p")])
...
symtr =
  Table
    "tr"
    ["rid", "tid", "name"]
    (mrgReturn [(mrgReturn . Just <$> [ssymb "tr0-0", ssymb "tr0-1", ssymb "tr0-2"], ssymb "tr0-p")])
...
symta =
  Table
    "ta"
    ["rid", "status"]
    (mrgReturn [(mrgReturn . Just <$> [ssymb "ta0-0", ssymb "ta0-1"], ssymb "ta0-p")])
...
symtb =
  Table
    "tb"
    ["rid", "status"]
    (mrgReturn [(mrgReturn . Just <$> [ssymb "tb0-0", ssymb "tb0-1"], ssymb "tb0-p")])
...
conct =
  Table
    "t"
    ["tid", "name"]
    (mrgReturn [(mrgReturn . Just <$> [-8, 0], 7)])
...
conctr =
  Table
    "tr"
    ["rid", "tid", "name"]
    (mrgReturn [(mrgReturn . Just <$> [-7, -8, 1], 0)])
...
concta =
  Table
    "ta"
    ["rid", "status"]
    (mrgReturn [(mrgReturn . Just <$> [-6, 0], 10)])
...
conctb =
  Table
    "tb"
    ["rid", "status"]
    (mrgReturn [(mrgReturn . Just <$> [0, 0], 15)])
