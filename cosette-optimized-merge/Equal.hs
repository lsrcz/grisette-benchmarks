...
getMultiplicity r = foldr (\(r1, p1) t -> mrgIte (r1 .== r) p1 0 + t) 0
...
elementContain r = foldr (\r1 a -> a .|| r .== r1) (con False)

contain :: RawTable -> RawTable -> SymBool
contain t1 t2 = foldr (\r a -> a .&& elementContain r t2) (con True) t1
...
verifCondition q1 q2 = [||$$(tableAllRepOk q1) .&& $$(tableAllRepOk q2) .&& symNot $$(same q1 q2)||]
