...
cbmcRightToMaybe :: CBMCEither a b -> Maybe b
...
reduceType ::
  ...
  Bool ->
  DotTree ->
  CBMCExceptT BonsaiError UnionM (UnionM DotResult)
...
subType :: Int -> UnionM DotResult -> UnionM DotResult -> CBMCExceptT BonsaiError UnionM SymBool
...
type' :: DotTree -> Env DotBitWidth DotResult -> CBMCExceptT BonsaiError UnionM (UnionM DotResult)
...
typer :: DotTree -> CBMCExceptT BonsaiError UnionM (UnionM DotResult)
...
execDot :: DotTree -> CBMCExceptT BonsaiError UnionM (UnionM DotResult)
execDot tree = do
