...
data Errors = EvalError
  ...
  deriving (Mergeable) via (Default Errors)
...
data Machine = Machine
  ...
  deriving (SimpleMergeable, Mergeable) via (Default Machine)
...
instance GenSym Exact Program

instance GenSymSimple Exact Program where
  simpleFresh (Exact spec) = traverse fresh spec
